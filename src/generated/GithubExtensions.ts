...
export class GithubClient extends ConnectorClientBase {
     ...
     */
    public async getUser(options: ConnectorOperationOptions = {}): Promise<UserDetailsModel> {
        const requestPath = `/user`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UserDetailsModel>("Github.getUser", "GetUser", "GET", requestUrl, undefined, options);
     ...
     */
    public async searchGithubWithQuery(input: GraphQlQuery, options: ConnectorOperationOptions = {}): Promise<void> {
        const requestPath = `/graphql`;
        const requestUrl = this.resolveUrl(requestPath);
        await this.sendWithTracingAsync<void>("Github.searchGithubWithQuery", "SearchGithubWithQuery", "POST", requestUrl, input, options);
    }
    ...
    public listCollaborators(repositoryOwner: string, repositoryName: string, options: ListCollaboratorsOptions = {}): ConnectorPagedAsyncIterableIterator<GeneralAPIModel> {
        ...
        return this.createPageable<Array<GeneralAPIModel>, GeneralAPIModel>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<Array<GeneralAPIModel>>("Github.listCollaborators", "ListCollaborators", "GET", requestUrl, undefined, options);
    ...
    public async getUserRepos(options: GetUserReposOptions = {}): Promise<Array<GeneralAPIModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<GeneralAPIModel>>("Github.getUserRepos", "GetUserRepos", "GET", requestUrl, undefined, options);
    ...
    public async searchIssues(q: string, options: SearchIssuesOptions = {}): Promise<MultipleSearchFetchModel> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<MultipleSearchFetchModel>("Github.searchIssues", "SearchIssues", "GET", requestUrl, undefined, options);
