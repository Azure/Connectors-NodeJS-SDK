...
export class Office365usersClient extends ConnectorClientBase {
     ...
     */
    public async updateMyProfile(input: GraphUserUpdateable, options: ConnectorOperationOptions = {}): Promise<void> {
        const requestPath = `/codeless/v1.0/me`;
        const requestUrl = this.resolveUrl(requestPath);
        await this.sendWithTracingAsync<void>("Office365users.updateMyProfile", "UpdateMyProfile", "PATCH", requestUrl, input, options);
    }
    ...
    public async myTrendingDocuments(options: MyTrendingDocumentsOptions = {}): Promise<MyTrendingDocumentsResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<MyTrendingDocumentsResponse>("Office365users.myTrendingDocuments", "MyTrendingDocuments", "GET", requestUrl, undefined, options);
    ...
    public async myProfile(options: MyProfileOptions = {}): Promise<GraphUser> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GraphUser>("Office365users.myProfile", "MyProfile_V2", "GET", requestUrl, undefined, options);
    ...
    public searchUser(options: SearchUserOptions = {}): ConnectorPagedAsyncIterableIterator<User> {
        ...
        return this.createPageable<EntityListResponseIReadOnlyListUser, User>(
            ...
            async (requestUrl, isFirstPage) => {
                ...
                const httpResponse = await this.sendWithTracingAsync<EntityListResponseIReadOnlyListUser>("Office365users.searchUser", "SearchUserV2", requestMethod, requestUrl, undefined, options);
