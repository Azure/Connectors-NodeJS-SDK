...
export class MicrosoftformsClient extends ConnectorClientBase {
     ...
     */
    public async getFormResponseByIdAsync(formId: string, responseId?: string, abortSignal?: AbortSignal): Promise<GetFormResponseByIdResult> {
     ...
     */
    public async getFormDetailsByIdAsync(formId: string, select?: string, abortSignal?: AbortSignal): Promise<GetFormDetailsByIdResult> {
        const queryParams: string[] = [];
        if (select !== undefined) {
