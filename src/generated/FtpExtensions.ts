...
export class FtpClient extends ConnectorClientBase {
     ...
     */
    public async extractFolderAsync(source?: string, destination?: string, overwrite?: string, createFolders?: string, queryParametersSingleEncoded?: string, abortSignal?: AbortSignal): Promise<Array<BlobMetadata>> {
        const queryParams: string[] = [];
        if (source !== undefined) {
            queryParams.push(`source=${encodeURIComponent(String(source))}`);
        }
