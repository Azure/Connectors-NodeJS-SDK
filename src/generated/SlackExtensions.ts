...
export class SlackClient extends ConnectorClientBase {
     ...
     */
    public async setDNDAsync(numMinutes?: string, abortSignal?: AbortSignal): Promise<SetDNDResponse> {
     ...
     */
    public async createChannelAsync(name?: string, isPrivate?: string, abortSignal?: AbortSignal): Promise<CreateChannelResponse> {
        const queryParams: string[] = [];
        if (name !== undefined) {
     ...
     */
    public async joinChannelAsync(channel?: string, abortSignal?: AbortSignal): Promise<JoinChannelResponse> {
        const queryParams: string[] = [];
     ...
     */
    public async listChannelsAsync(abortSignal?: AbortSignal): Promise<ListChannelsResponse> {
