...
export class SlackClient extends ConnectorClientBase {
    ...
    public async setDND(numMinutes?: string, options: ConnectorOperationOptions = {}): Promise<SetDNDResponse> {
        ...
        const httpResponse = await this.sendWithTracingAsync<SetDNDResponse>("Slack.setDND", "SetDND", "GET", requestUrl, undefined, options);
    ...
    public async createChannel(name?: string, isPrivate?: string, options: ConnectorOperationOptions = {}): Promise<CreateChannelResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateChannelResponse>("Slack.createChannel", "CreateChannel_V2", "POST", requestUrl, undefined, options);
    ...
    public async joinChannel(channel?: string, options: ConnectorOperationOptions = {}): Promise<JoinChannelResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<JoinChannelResponse>("Slack.joinChannel", "JoinChannel_V2", "POST", requestUrl, undefined, options);
     ...
     */
    public listChannels(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Channel> {
        ...
        return this.createPageable<ListChannelsResponse, Channel>(
            ...
            async (requestUrl, isFirstPage) => {
                ...
                const httpResponse = await this.sendWithTracingAsync<ListChannelsResponse>("Slack.listChannels", "ListChannels_V3", requestMethod, requestUrl, undefined, options);
     ...
     */
    public async postMessage(input: PostMessageRequest, options: ConnectorOperationOptions = {}): Promise<PostMessageResponse> {
        const requestPath = `/v2/chat.postMessage`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<PostMessageResponse>("Slack.postMessage", "PostMessage_V2", "POST", requestUrl, input, options);
