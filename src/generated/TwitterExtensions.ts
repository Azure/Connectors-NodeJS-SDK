...
export class TwitterClient extends ConnectorClientBase {
    ...
    public async userTimeline(userName: string, options: UserTimelineOptions = {}): Promise<Array<TweetModel>> {
        ...
        const httpResponse = await this.sendWithTracingAsync<Array<TweetModel>>("Twitter.userTimeline", "UserTimeline", "GET", requestUrl, undefined, options);
    ...
    public async homeTimeline(options: HomeTimelineOptions = {}): Promise<Array<TweetModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<TweetModel>>("Twitter.homeTimeline", "HomeTimeline", "GET", requestUrl, undefined, options);
    ...
    public async searchTweet(searchQuery: string, options: SearchTweetOptions = {}): Promise<Array<TweetModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<TweetModel>>("Twitter.searchTweet", "SearchTweet", "GET", requestUrl, undefined, options);
    ...
    public async followers(userName: string, options: FollowersOptions = {}): Promise<Array<UserDetailsModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<UserDetailsModel>>("Twitter.followers", "Followers", "GET", requestUrl, undefined, options);
    ...
    public async myFollowers(options: MyFollowersOptions = {}): Promise<Array<UserDetailsModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<UserDetailsModel>>("Twitter.myFollowers", "MyFollowers", "GET", requestUrl, undefined, options);
    ...
    public async following(userName: string, options: FollowingOptions = {}): Promise<Array<UserDetailsModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<UserDetailsModel>>("Twitter.following", "Following", "GET", requestUrl, undefined, options);
    ...
    public async myFollowing(options: MyFollowingOptions = {}): Promise<Array<UserDetailsModel>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<UserDetailsModel>>("Twitter.myFollowing", "MyFollowing", "GET", requestUrl, undefined, options);
    ...
    public async tweet(input: TweetInput, options: TweetOptions = {}): Promise<TweetResponseModel> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<TweetResponseModel>("Twitter.tweet", "Tweet", "POST", requestUrl, input, options);
    ...
    public async retweet(tweetId: string, options: RetweetOptions = {}): Promise<TweetResponseModel> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<TweetResponseModel>("Twitter.retweet", "Retweet", "POST", requestUrl, undefined, options);
