...
export class MailchimpClient extends ConnectorClientBase {
     ...
     */
    public async getListsAsync(count?: string, offset?: string, abortSignal?: AbortSignal): Promise<GetListsResponseModel> {
     ...
     */
    public async addMembersAsync(input: NewMembersInListRequest, listId: string, skipMergeValidation?: string, skipDuplicateCheck?: string, abortSignal?: AbortSignal): Promise<GetAddMembersBatchResponseModel> {
        const queryParams: string[] = [];
     ...
     */
    public async getListMembersAsync(listId: string, count?: string, offset?: string, abortSignal?: AbortSignal): Promise<GetAllMembersResponseModel> {
        const queryParams: string[] = [];
        if (count !== undefined) {
            queryParams.push(`count=${encodeURIComponent(String(count))}`);
        }
