...
export class MondayClient extends ConnectorClientBase {
     ...
     */
    public async createItem(input: CreateItemInput, options: ConnectorOperationOptions = {}): Promise<CreateItemResponse> {
        const requestPath = `/executePowerAutomateAction/CreateItem`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateItemResponse>("Monday.createItem", "CreateItem", "POST", requestUrl, input, options);
     ...
     */
    public async duplicateBoard(input: DuplicateBoardInput, options: ConnectorOperationOptions = {}): Promise<DuplicateBoardResponse> {
        const requestPath = `/executePowerAutomateAction/DuplicateBoard`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DuplicateBoardResponse>("Monday.duplicateBoard", "DuplicateBoard", "POST", requestUrl, input, options);
     ...
     */
    public async createBoard(input: CreateBoardInput, options: ConnectorOperationOptions = {}): Promise<CreateBoardResponse> {
        const requestPath = `/executePowerAutomateAction/CreateBoard`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateBoardResponse>("Monday.createBoard", "CreateBoard", "POST", requestUrl, input, options);
     ...
     */
    public async createColumn(input: CreateColumnInput, options: ConnectorOperationOptions = {}): Promise<CreateColumnResponse> {
        const requestPath = `/executePowerAutomateAction/CreateColumn`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateColumnResponse>("Monday.createColumn", "CreateColumn", "POST", requestUrl, input, options);
     ...
     */
    public async createGroup(input: CreateGroupInput, options: ConnectorOperationOptions = {}): Promise<CreateGroupResponse> {
        const requestPath = `/executePowerAutomateAction/CreateGroup`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateGroupResponse>("Monday.createGroup", "CreateGroup", "POST", requestUrl, input, options);
     ...
     */
    public async updateItemColumn(input: UpdateItemColumnInput, options: ConnectorOperationOptions = {}): Promise<UpdateItemColumnResponse> {
        const requestPath = `/executePowerAutomateAction/UpdateItemColumn`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UpdateItemColumnResponse>("Monday.updateItemColumn", "UpdateItemColumn", "POST", requestUrl, input, options);
     ...
     */
    public async updateMultipleItemColumns(input: UpdateMultipleItemColumnsInput, options: ConnectorOperationOptions = {}): Promise<UpdateMultipleItemColumnsResponse> {
        const requestPath = `/executePowerAutomateAction/UpdateMultipleItemColumns`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UpdateMultipleItemColumnsResponse>("Monday.updateMultipleItemColumns", "UpdateMultipleItemColumns", "POST", requestUrl, input, options);
     ...
     */
    public async moveItemToGroup(input: MoveItemToGroupInput, options: ConnectorOperationOptions = {}): Promise<MoveItemToGroupResponse> {
        const requestPath = `/executePowerAutomateAction/MoveItemToGroup`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<MoveItemToGroupResponse>("Monday.moveItemToGroup", "MoveItemToGroup", "POST", requestUrl, input, options);
     ...
     */
    public async createNotification(input: CreateNotificationInput, options: ConnectorOperationOptions = {}): Promise<CreateNotificationResponse> {
        const requestPath = `/executePowerAutomateAction/CreateNotification`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateNotificationResponse>("Monday.createNotification", "CreateNotification", "POST", requestUrl, input, options);
     ...
     */
    public async createSubitem(input: CreateSubitemInput, options: ConnectorOperationOptions = {}): Promise<CreateSubitemResponse> {
        const requestPath = `/executePowerAutomateAction/CreateSubitem`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateSubitemResponse>("Monday.createSubitem", "CreateSubitem", "POST", requestUrl, input, options);
     ...
     */
    public async createUpdate(input: CreateUpdateInput, options: ConnectorOperationOptions = {}): Promise<CreateUpdateResponse> {
        const requestPath = `/executePowerAutomateAction/CreateUpdate`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateUpdateResponse>("Monday.createUpdate", "CreateUpdate", "POST", requestUrl, input, options);
     ...
     */
    public async createWorkspace(input: CreateWorkspaceInput, options: ConnectorOperationOptions = {}): Promise<CreateWorkspaceResponse> {
        const requestPath = `/executePowerAutomateAction/CreateWorkspaceV2`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateWorkspaceResponse>("Monday.createWorkspace", "CreateWorkspace_V2", "POST", requestUrl, input, options);
    ...
    public async getItems(workspaceId?: string, boardId?: string, groupId?: string, filter1Column?: string, filter1Operator?: string, filter1Value?: string, filter2Column?: string, filter2Operator?: string, filter2Value?: string, filter3Column?: string, filter3Operator?: string, filter3Value?: string, filter4Column?: string, filter4Operator?: string, filter4Value?: string, options: ConnectorOperationOptions = {}): Promise<DynamicGetGetItemsSchema> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DynamicGetGetItemsSchema>("Monday.getItems", "GetItems_V2", "GET", requestUrl, undefined, options);
     ...
     */
    public async getTags(options: ConnectorOperationOptions = {}): Promise<GetTagsResponse> {
        const requestPath = `/getData/getTagsV2`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetTagsResponse>("Monday.getTags", "GetTags_V2", "GET", requestUrl, undefined, options);
     ...
     */
    public async getUsers(options: ConnectorOperationOptions = {}): Promise<GetUsersResponse> {
        const requestPath = `/getData/getUsersV2`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetUsersResponse>("Monday.getUsers", "GetUsers_V2", "GET", requestUrl, undefined, options);
