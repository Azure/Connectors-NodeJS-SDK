...
export class WaywedoClient extends ConnectorClientBase {
     ...
     */
    public async addComment(input: CommentAddInput, options: ConnectorOperationOptions = {}): Promise<ChecklistComment> {
        const requestPath = `/v1/ChecklistInstanceComments`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<ChecklistComment>("Waywedo.addComment", "Comment_Add", "POST", requestUrl, input, options);
     ...
     */
    public async checklistInstances(input: ChecklistInstancesInput, options: ConnectorOperationOptions = {}): Promise<ChecklistInstance> {
        const requestPath = `/v1/ChecklistInstances`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<ChecklistInstance>("Waywedo.checklistInstances", "ChecklistInstances_Post", "POST", requestUrl, input, options);
     ...
     */
    public async addCollaborators(input: CollaboratorsAddInput, options: ConnectorOperationOptions = {}): Promise<CollaboratorsAddResponse> {
        const requestPath = `/v1/Collaborators`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CollaboratorsAddResponse>("Waywedo.addCollaborators", "Collaborators_Add", "POST", requestUrl, input, options);
    ...
    public async findUser(options: FindUserOptions = {}): Promise<Array<User>> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<User>>("Waywedo.findUser", "Find_User", "GET", requestUrl, undefined, options);
     ...
     */
    public async users(input: UsersInput, options: ConnectorOperationOptions = {}): Promise<UsersPostResponse> {
        const requestPath = `/v1/Users`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UsersPostResponse>("Waywedo.users", "Users_Post", "POST", requestUrl, input, options);
