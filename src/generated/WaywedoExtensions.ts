...
export class WaywedoClient extends ConnectorClientBase {
     ...
     */
    public async commentAddAsync(input: CommentAddInput, abortSignal?: AbortSignal): Promise<ChecklistComment> {
     ...
     */
    public async checklistInstancesAsync(input: ChecklistInstancesInput, abortSignal?: AbortSignal): Promise<ChecklistInstance> {
     ...
     */
    public async checklistInstancesGetAsync(instanceId: string, abortSignal?: AbortSignal): Promise<ChecklistInstance> {
     ...
     */
    public async checklistInstancesActivityAsync(instanceId: string, abortSignal?: AbortSignal): Promise<Array<Record<string, unknown>>> {
     ...
     */
    public async findStepsAsync(instanceId: string, query?: string, abortSignal?: AbortSignal): Promise<Array<ChecklistStep>> {
     ...
     */
    public async checklistStepsGetAsync(instanceId: string, stepId: string, abortSignal?: AbortSignal): Promise<ChecklistStep> {
     ...
     */
    public async checklistStepsCompleteAsync(input: ChecklistStepsCompleteInput, instanceId: string, stepId: string, abortSignal?: AbortSignal): Promise<ChecklistStepsCompleteResponse> {
     ...
     */
    public async collaboratorsAddAsync(input: CollaboratorsAddInput, abortSignal?: AbortSignal): Promise<CollaboratorsAddResponse> {
     ...
     */
    public async findChecklistAsync(query?: string, type?: string, abortSignal?: AbortSignal): Promise<Array<Procedure>> {
        const queryParams: string[] = [];
        if (query !== undefined) {
            queryParams.push(`query=${encodeURIComponent(String(query))}`);
        }
     ...
     */
    public async proceduresGetAsync(procedureId: string, abortSignal?: AbortSignal): Promise<Procedure> {
     ...
     */
    public async findChecklistInstancesAsync(procedureId: string, query?: string, abortSignal?: AbortSignal): Promise<Array<ChecklistInstance>> {
        const queryParams: string[] = [];
        if (query !== undefined) {
            queryParams.push(`query=${encodeURIComponent(String(query))}`);
        }
     ...
     */
    public async findUserAsync(query?: string, abortSignal?: AbortSignal): Promise<Array<User>> {
        const queryParams: string[] = [];
        if (query !== undefined) {
            queryParams.push(`query=${encodeURIComponent(String(query))}`);
        }
     ...
     */
    public async usersAsync(input: UsersInput, abortSignal?: AbortSignal): Promise<UsersPostResponse> {
