...
export class DynamicsaxClient extends ConnectorClientBase {
     ...
     */
    public async getItemsAsync(dataset: string, table: string, apply?: string, filter?: string, orderby?: string, top?: string, skip?: string, select?: string, crossCompany?: string, abortSignal?: AbortSignal): Promise<ItemsList> {
