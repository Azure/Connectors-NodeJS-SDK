...
export class TextrequestClient extends ConnectorClientBase {
     ...
     */
    public async getMessagesByContactPhone(dashboardId: string, phoneNumber: string, page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetMessagesByContactPhoneResponse> {
     ...
     */
    public async sendMessageByPhoneNumber(input: SendMessageByPhoneNumberInput, dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<SendMessageByPhoneNumberResponse> {
     ...
     */
    public async archiveConversation(dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<string> {
     ...
     */
    public async unarchiveConversation(dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<string> {
     ...
     */
    public async getContactByPhoneNumber(dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<GetContactByPhoneNumberResponse> {
     ...
     */
    public async deleteContact(dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<string> {
        const requestPath = `/dashboards/${dashboardId}/contacts/${phoneNumber}`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async createContact(input: CreateContactInput, dashboardId: string, phoneNumber: string, abortSignal?: AbortSignalLike): Promise<CreateContactResponse> {
        const requestPath = `/dashboards/${dashboardId}/contacts/${phoneNumber}`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async updateBulkContacts(input: BulkUpdateContactsInput, dashboardId: string, abortSignal?: AbortSignalLike): Promise<Array<Record<string, unknown>>> {
     ...
     */
    public async getGroupById(dashboardId: string, groupId: string, abortSignal?: AbortSignalLike): Promise<GetGroupByIdResponse> {
     ...
     */
    public async deleteGroup(dashboardId: string, groupId: string, abortSignal?: AbortSignalLike): Promise<string> {
        const requestPath = `/dashboards/${dashboardId}/groups/${groupId}`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.httpClient.sendAsync<string>("DELETE", requestUrl, undefined, undefined, abortSignal);
     ...
     */
    public async updateGroup(input: UpdateGroupInput, dashboardId: string, groupId: string, abortSignal?: AbortSignalLike): Promise<UpdateGroupResponse> {
        const requestPath = `/dashboards/${dashboardId}/groups/${groupId}`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async getGroups(dashboardId: string, page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetGroupsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
     ...
     */
    public async createGroup(input: CreateGroupInput, dashboardId: string, abortSignal?: AbortSignalLike): Promise<CreateGroupResponse> {
     ...
     */
    public async getTags(dashboardId: string, page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetTagsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
     ...
     */
    public async getCustomFields(dashboardId: string, abortSignal?: AbortSignalLike): Promise<Array<Record<string, unknown>>> {
     ...
     */
    public async getPayment(dashboardId: string, paymentId: string, abortSignal?: AbortSignalLike): Promise<GetPaymentResponse> {
     ...
     */
    public async markPaymentPaid(dashboardId: string, paymentId: string, abortSignal?: AbortSignalLike): Promise<MarkPaymentPaidResponse> {
     ...
     */
    public async sendPaymentReminder(dashboardId: string, paymentId: string, abortSignal?: AbortSignalLike): Promise<SendPaymentReminderResponse> {
     ...
     */
    public async cancelPayment(dashboardId: string, paymentId: string, abortSignal?: AbortSignalLike): Promise<CancelPaymentResponse> {
     ...
     */
    public async getPayments(dashboardId: string, referenceNumber?: string, phoneNumber?: string, sortType?: string, sortDirection?: string, page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetPaymentsResponse> {
        const queryParams: string[] = [];
     ...
     */
    public async createPayment(input: CreatePaymentInput, dashboardId: string, abortSignal?: AbortSignalLike): Promise<CreatePaymentResponse> {
     ...
     */
    public async getDashboard(dashboardId: string, abortSignal?: AbortSignalLike): Promise<GetDashboardResponse> {
     ...
     */
    public async deleteDashboard(dashboardId: string, abortSignal?: AbortSignalLike): Promise<string> {
        const requestPath = `/dashboards/${dashboardId}`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.httpClient.sendAsync<string>("DELETE", requestUrl, undefined, undefined, abortSignal);
     ...
     */
    public async updateDashboardsName(input: UpdateDashboardsNameInput, dashboardId: string, abortSignal?: AbortSignalLike): Promise<UpdateDashboardsNameResponse> {
        const requestPath = `/dashboards/${dashboardId}`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async getConversations(dashboardId: string, tags?: string, showUnresolvedOnly?: string, includeArchived?: string, search?: string, page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetConversationsResponse> {
        const queryParams: string[] = [];
        if (tags !== undefined) {
            queryParams.push(`tags=${encodeURIComponent(String(tags))}`);
        }
     ...
     */
    public async getDashboards(page?: string, pageSize?: string, abortSignal?: AbortSignalLike): Promise<GetDashboardsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
     ...
     */
    public async createDashboard(input: CreateDashboardInput, abortSignal?: AbortSignalLike): Promise<CreateDashboardResponse> {
