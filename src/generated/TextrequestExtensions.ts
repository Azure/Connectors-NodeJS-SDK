...
export class TextrequestClient extends ConnectorClientBase {
     ...
     */
    public async getMessagesByContactPhoneAsync(dashboardId: string, phoneNumber: string, page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetMessagesByContactPhoneResponse> {
     ...
     */
    public async getGroupsAsync(dashboardId: string, page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetGroupsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
     ...
     */
    public async getTagsAsync(dashboardId: string, page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetTagsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
     ...
     */
    public async getPaymentsAsync(dashboardId: string, referenceNumber?: string, phoneNumber?: string, sortType?: string, sortDirection?: string, page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetPaymentsResponse> {
        const queryParams: string[] = [];
     ...
     */
    public async getConversationsAsync(dashboardId: string, tags?: string, showUnresolvedOnly?: string, includeArchived?: string, search?: string, page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetConversationsResponse> {
        const queryParams: string[] = [];
        if (tags !== undefined) {
            queryParams.push(`tags=${encodeURIComponent(String(tags))}`);
        }
     ...
     */
    public async getDashboardsAsync(page?: string, pageSize?: string, abortSignal?: AbortSignal): Promise<GetDashboardsResponse> {
        const queryParams: string[] = [];
        if (page !== undefined) {
            queryParams.push(`page=${encodeURIComponent(String(page))}`);
        }
