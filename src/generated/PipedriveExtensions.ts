...
export class PipedriveClient extends ConnectorClientBase {
     ...
     */
    public async addActivity(input: AddActivityRequest, options: ConnectorOperationOptions = {}): Promise<ActivityResponse> {
        const requestPath = `/v1/activities`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<ActivityResponse>("Pipedrive.addActivity", "AddActivity", "POST", requestUrl, input, options);
     ...
     */
    public async addDeal(input: AddDealRequest, options: ConnectorOperationOptions = {}): Promise<DealResponseV2> {
        const requestPath = `/connector-v2/v1/deals`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DealResponseV2>("Pipedrive.addDeal", "AddDealV2", "POST", requestUrl, input, options);
