...
export class WordpressClient extends ConnectorClientBase {
     ...
     */
    public async siteStatsAsync(siteId: string, fields?: string, abortSignal?: AbortSignal): Promise<SiteStatsModel> {
     ...
     * @remarks Get post
     */
    public async getAsync(siteId: string, postId: string, abortSignal?: AbortSignal): Promise<PostModel> {
     ...
     * @remarks Create post
     */
    public async createAsync(input: CreatePostModel, siteId: string, abortSignal?: AbortSignal): Promise<PostModel> {
