...
export class WebexClient extends ConnectorClientBase {
     ...
     */
    public async createSpaceMember(input: CreateSpaceMemberInput, options: ConnectorOperationOptions = {}): Promise<CreateSpaceMemberResponse> {
        const requestPath = `/v1/memberships`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateSpaceMemberResponse>("Webex.createSpaceMember", "CreateSpaceMember", "POST", requestUrl, input, options);
    ...
    public async getMessages(roomId?: string, mentionedPeople?: string, beforeMessage?: string, before?: string, max?: string, options: ConnectorOperationOptions = {}): Promise<GetMessagesResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetMessagesResponse>("Webex.getMessages", "GetMessages", "GET", requestUrl, undefined, options);
     ...
     */
    public async sendMessage(input: SendMessageInput, options: ConnectorOperationOptions = {}): Promise<SendMessageResponse> {
        const requestPath = `/v1/messages`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<SendMessageResponse>("Webex.sendMessage", "SendMessage", "POST", requestUrl, input, options);
    ...
    public async getPeople(id?: string, email?: string, options: ConnectorOperationOptions = {}): Promise<GetPeopleResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetPeopleResponse>("Webex.getPeople", "GetPeople", "GET", requestUrl, undefined, options);
     ...
     */
    public async getMyOwnDetails(options: ConnectorOperationOptions = {}): Promise<GetMyOwnDetailsResponse> {
        const requestPath = `/v1/people/me`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetMyOwnDetailsResponse>("Webex.getMyOwnDetails", "GetMyOwnDetails", "GET", requestUrl, undefined, options);
    ...
    public async getSpaces(max?: string, type?: string, sortBy?: string, options: ConnectorOperationOptions = {}): Promise<GetSpacesResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetSpacesResponse>("Webex.getSpaces", "GetSpaces", "GET", requestUrl, undefined, options);
     ...
     */
    public async createSpace(input: CreateSpaceInput, options: ConnectorOperationOptions = {}): Promise<CreateSpaceResponse> {
        const requestPath = `/v1/rooms`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateSpaceResponse>("Webex.createSpace", "CreateSpace", "POST", requestUrl, input, options);
     ...
     */
    public async createTeamMember(input: CreateTeamMemberInput, options: ConnectorOperationOptions = {}): Promise<CreateTeamMemberResponse> {
        const requestPath = `/v1/team/memberships`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateTeamMemberResponse>("Webex.createTeamMember", "CreateTeamMember", "POST", requestUrl, input, options);
