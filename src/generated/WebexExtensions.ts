...
export class WebexClient extends ConnectorClientBase {
     ...
     */
    public async getMessagesAsync(roomId?: string, mentionedPeople?: string, beforeMessage?: string, before?: string, max?: string, abortSignal?: AbortSignal): Promise<GetMessagesResponse> {
     ...
     */
    public async getPeopleAsync(id?: string, email?: string, abortSignal?: AbortSignal): Promise<GetPeopleResponse> {
        const queryParams: string[] = [];
        if (id !== undefined) {
     ...
     */
    public async getSpacesAsync(max?: string, type?: string, sortBy?: string, abortSignal?: AbortSignal): Promise<GetSpacesResponse> {
        const queryParams: string[] = [];
        if (max !== undefined) {
            queryParams.push(`max=${encodeURIComponent(String(max))}`);
        }
