...
export class FreshserviceClient extends ConnectorClientBase {
     ...
     */
    public async createTicket(input: CreateTicketRequest, options: ConnectorOperationOptions = {}): Promise<CreateUpdateTicketResponse> {
        const requestPath = `/api/v2/tickets`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateUpdateTicketResponse>("Freshservice.createTicket", "CreateTicketV2", "POST", requestUrl, input, options);
