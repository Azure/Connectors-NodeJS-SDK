...
export class ShiftsClient extends ConnectorClientBase {
     ...
     */
    public async listTimesOffAsync(teamId: string, startTime?: string, endTime?: string, top?: string, abortSignal?: AbortSignal): Promise<ListTimesOffResponse> {
     ...
     */
    public async listShiftsAsync(teamId: string, startTime?: string, endTime?: string, top?: string, abortSignal?: AbortSignal): Promise<ListShiftsResponse> {
        const queryParams: string[] = [];
        if (startTime !== undefined) {
            queryParams.push(`startTime=${encodeURIComponent(String(startTime))}`);
        }
     ...
     */
    public async listOpenShiftsAsync(teamId: string, startTime?: string, endTime?: string, top?: string, abortSignal?: AbortSignal): Promise<ListOpenShiftsResponse> {
        const queryParams: string[] = [];
        if (startTime !== undefined) {
            queryParams.push(`startTime=${encodeURIComponent(String(startTime))}`);
        }
     ...
     */
    public async listTimeOffReasonsAsync(teamId: string, top?: string, abortSignal?: AbortSignal): Promise<GetTimeOffReasonsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listSchedulingGroupsAsync(teamId: string, top?: string, abortSignal?: AbortSignal): Promise<ListSchedulingGroupsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listTimeOffRequestsAsync(teamId: string, top?: string, state?: string, abortSignal?: AbortSignal): Promise<ListTimeOffRequestsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listOfferShiftRequestsAsync(teamId: string, top?: string, state?: string, abortSignal?: AbortSignal): Promise<ListOfferShiftRequestsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listSwapShiftsChangeRequestsAsync(teamId: string, top?: string, state?: string, abortSignal?: AbortSignal): Promise<ListSwapShiftsChangeRequestsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listOpenShiftChangeRequestsAsync(teamId: string, top?: string, state?: string, abortSignal?: AbortSignal): Promise<ListOpenShiftChangeRequestsResponse> {
        const queryParams: string[] = [];
        if (top !== undefined) {
            queryParams.push(`$top=${encodeURIComponent(String(top))}`);
        }
     ...
     */
    public async listOpenShiftsCrossTeamAsync(startTime?: string, endTime?: string, top?: string, abortSignal?: AbortSignal): Promise<ListOpenShiftsCrossTeamResponse> {
        const queryParams: string[] = [];
        if (startTime !== undefined) {
            queryParams.push(`startTime=${encodeURIComponent(String(startTime))}`);
        }
     ...
     */
    public async listShiftsCrossTeamAsync(startTime?: string, endTime?: string, assignedToUserName?: string, top?: string, abortSignal?: AbortSignal): Promise<ListShiftsCrossTeamResponse> {
        const queryParams: string[] = [];
        if (startTime !== undefined) {
            queryParams.push(`startTime=${encodeURIComponent(String(startTime))}`);
        }
     ...
     */
    public async listTimesOffCrossTeamAsync(startTime?: string, endTime?: string, assignedToUserName?: string, top?: string, abortSignal?: AbortSignal): Promise<ListTimesOffCrossTeamResponse> {
        const queryParams: string[] = [];
        if (startTime !== undefined) {
            queryParams.push(`startTime=${encodeURIComponent(String(startTime))}`);
        }
