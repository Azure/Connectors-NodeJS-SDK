...
export class Starrezrestv1Client extends ConnectorClientBase {
     ...
     */
    public async selectEntry(input: SelectEntryInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/entry.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntry", "SelectEntry", "POST", requestUrl, input, options);
     ...
     */
    public async createEntry(input: CreateEntryInput, options: ConnectorOperationOptions = {}): Promise<CreateEntryResponse> {
        const requestPath = `/create/entry.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateEntryResponse>("Starrezrestv1.createEntry", "CreateEntry", "POST", requestUrl, input, options);
     ...
     */
    public async selectEntryCustomField(input: SelectEntryCustomFieldInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/EntryCustomField.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntryCustomField", "SelectEntryCustomField", "POST", requestUrl, input, options);
     ...
     */
    public async selectTerm(input: SelectTermInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/Term.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectTerm", "SelectTerm", "POST", requestUrl, input, options);
     ...
     */
    public async selectEntryAddress(input: SelectEntryAddressInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/EntryAddress.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntryAddress", "SelectEntryAddress", "POST", requestUrl, input, options);
     ...
     */
    public async selectEntryApplication(input: SelectEntryApplicationInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/EntryApplication.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntryApplication", "SelectEntryApplication", "POST", requestUrl, input, options);
     ...
     */
    public async createEntryApplication(input: CreateEntryApplicationInput, options: ConnectorOperationOptions = {}): Promise<CreateEntryApplicationResponse> {
        const requestPath = `/create/entryapplication.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateEntryApplicationResponse>("Starrezrestv1.createEntryApplication", "CreateEntryApplication", "POST", requestUrl, input, options);
     ...
     */
    public async selectTermSession(input: SelectTermSessionInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/TermSession.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectTermSession", "SelectTermSession", "POST", requestUrl, input, options);
     ...
     */
    public async selectEntryDetail(input: SelectEntryDetailInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/EntryDetail.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntryDetail", "SelectEntryDetail", "POST", requestUrl, input, options);
     ...
     */
    public async selectEntryEnrollment(input: SelectEntryEnrollmentInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/EntryEnrollment.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectEntryEnrollment", "SelectEntryEnrollment", "POST", requestUrl, input, options);
     ...
     */
    public async createEntryEnrollment(input: CreateEntryEnrollmentInput, options: ConnectorOperationOptions = {}): Promise<CreateEntryEnrollmentResponse> {
        const requestPath = `/create/entryenrollment.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateEntryEnrollmentResponse>("Starrezrestv1.createEntryEnrollment", "CreateEntryEnrollment", "POST", requestUrl, input, options);
     ...
     */
    public async selectBooking(input: SelectBookingInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/Booking.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectBooking", "SelectBooking", "POST", requestUrl, input, options);
     ...
     */
    public async createBooking(input: CreateBookingInput, options: ConnectorOperationOptions = {}): Promise<CreateBookingResponse> {
        const requestPath = `/create/booking.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateBookingResponse>("Starrezrestv1.createBooking", "CreateBooking", "POST", requestUrl, input, options);
     ...
     */
    public async selectRoomSpace(input: SelectRoomSpaceInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/RoomSpace.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectRoomSpace", "SelectRoomSpace", "POST", requestUrl, input, options);
     ...
     */
    public async createRoomSpace(input: CreateRoomSpaceInput, options: ConnectorOperationOptions = {}): Promise<CreateRoomSpaceResponse> {
        const requestPath = `/create/roomspace.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateRoomSpaceResponse>("Starrezrestv1.createRoomSpace", "CreateRoomSpace", "POST", requestUrl, input, options);
     ...
     */
    public async selectRoomLocation(input: SelectRoomLocationInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/RoomLocation.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectRoomLocation", "SelectRoomLocation", "POST", requestUrl, input, options);
     ...
     */
    public async selectTransaction(input: SelectTransactionInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/Transaction.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectTransaction", "SelectTransaction", "POST", requestUrl, input, options);
     ...
     */
    public async createTransaction(input: CreateTransactionInput, options: ConnectorOperationOptions = {}): Promise<CreateTransactionResponse> {
        const requestPath = `/create/transaction.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateTransactionResponse>("Starrezrestv1.createTransaction", "CreateTransaction", "POST", requestUrl, input, options);
     ...
     */
    public async selectRoomSpaceMaintenance(input: SelectRoomSpaceMaintenanceInput, options: ConnectorOperationOptions = {}): Promise<Array<Record<string, unknown>>> {
        const requestPath = `/select/RoomSpaceMaintenance.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Array<Record<string, unknown>>>("Starrezrestv1.selectRoomSpaceMaintenance", "SelectRoomSpaceMaintenance", "POST", requestUrl, input, options);
     ...
     */
    public async createRoomSpaceMaintenance(input: CreateRoomSpaceMaintenanceInput, options: ConnectorOperationOptions = {}): Promise<CreateRoomSpaceMaintenanceResponse> {
        const requestPath = `/create/roomspacemaintenance.json`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateRoomSpaceMaintenanceResponse>("Starrezrestv1.createRoomSpaceMaintenance", "CreateRoomSpaceMaintenance", "POST", requestUrl, input, options);
