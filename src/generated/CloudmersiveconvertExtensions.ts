...
export class CloudmersiveconvertClient extends ConnectorClientBase {
     ...
     */
    public async createEditDocumentDocxBlankDocument(input: CreateBlankDocxRequest, options: ConnectorOperationOptions = {}): Promise<CreateBlankDocxResponse> {
        const requestPath = `/convert/edit/docx/create/blank`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateBlankDocxResponse>("Cloudmersiveconvert.createEditDocumentDocxBlankDocument", "EditDocument_DocxCreateBlankDocument", "POST", requestUrl, input, options);
     ...
     */
    public async deleteEditDocumentDocxTableRow(input: DeleteDocxTableRowRequest, options: ConnectorOperationOptions = {}): Promise<DeleteDocxTableRowResponse> {
        const requestPath = `/convert/edit/docx/delete-table-row`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DeleteDocxTableRowResponse>("Cloudmersiveconvert.deleteEditDocumentDocxTableRow", "EditDocument_DocxDeleteTableRow", "POST", requestUrl, input, options);
     ...
     */
    public async deleteEditDocumentDocxTableRowRange(input: DeleteDocxTableRowRangeRequest, options: ConnectorOperationOptions = {}): Promise<DeleteDocxTableRowRangeResponse> {
        const requestPath = `/convert/edit/docx/delete-table-row/range`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DeleteDocxTableRowRangeResponse>("Cloudmersiveconvert.deleteEditDocumentDocxTableRowRange", "EditDocument_DocxDeleteTableRowRange", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxBody(input: GetDocxBodyRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxBodyResponse> {
        const requestPath = `/convert/edit/docx/get-body`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxBodyResponse>("Cloudmersiveconvert.editDocumentDocxBody", "EditDocument_DocxBody", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxCommentsHierarchical(input: GetDocxGetCommentsHierarchicalRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxCommentsHierarchicalResponse> {
        const requestPath = `/convert/edit/docx/get-comments/hierarchical`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxCommentsHierarchicalResponse>("Cloudmersiveconvert.getEditDocumentDocxCommentsHierarchical", "EditDocument_DocxGetCommentsHierarchical", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxHeadersAndFooters(input: GetDocxHeadersAndFootersRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxHeadersAndFootersResponse> {
        const requestPath = `/convert/edit/docx/get-headers-and-footers`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxHeadersAndFootersResponse>("Cloudmersiveconvert.getEditDocumentDocxHeadersAndFooters", "EditDocument_DocxGetHeadersAndFooters", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxImages(input: GetDocxImagesRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxImagesResponse> {
        const requestPath = `/convert/edit/docx/get-images`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxImagesResponse>("Cloudmersiveconvert.getEditDocumentDocxImages", "EditDocument_DocxGetImages", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxPages(input: GetDocxPagesRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxPagesResponse> {
        const requestPath = `/convert/edit/docx/get-pages`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxPagesResponse>("Cloudmersiveconvert.editDocumentDocxPages", "EditDocument_DocxPages", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxSections(input: GetDocxSectionsRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxSectionsResponse> {
        const requestPath = `/convert/edit/docx/get-sections`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxSectionsResponse>("Cloudmersiveconvert.getEditDocumentDocxSections", "EditDocument_DocxGetSections", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxStyles(input: GetDocxStylesRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxStylesResponse> {
        const requestPath = `/convert/edit/docx/get-styles`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxStylesResponse>("Cloudmersiveconvert.getEditDocumentDocxStyles", "EditDocument_DocxGetStyles", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxTableRow(input: GetDocxTableRowRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxTableRowResponse> {
        const requestPath = `/convert/edit/docx/get-table-row`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxTableRowResponse>("Cloudmersiveconvert.getEditDocumentDocxTableRow", "EditDocument_DocxGetTableRow", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxTableByIndex(input: GetDocxTableByIndexRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxTableByIndexResponse> {
        const requestPath = `/convert/edit/docx/get-table/by-index`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxTableByIndexResponse>("Cloudmersiveconvert.getEditDocumentDocxTableByIndex", "EditDocument_DocxGetTableByIndex", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentDocxTables(input: GetDocxTablesRequest, options: ConnectorOperationOptions = {}): Promise<GetDocxTablesResponse> {
        const requestPath = `/convert/edit/docx/get-tables`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetDocxTablesResponse>("Cloudmersiveconvert.getEditDocumentDocxTables", "EditDocument_DocxGetTables", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxInsertCommentOnParagraph(input: DocxInsertCommentOnParagraphRequest, options: ConnectorOperationOptions = {}): Promise<InsertDocxCommentOnParagraphResponse> {
        const requestPath = `/convert/edit/docx/insert-comment/on/paragraph`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<InsertDocxCommentOnParagraphResponse>("Cloudmersiveconvert.editDocumentDocxInsertCommentOnParagraph", "EditDocument_DocxInsertCommentOnParagraph", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxInsertImage(input: DocxInsertImageRequest, options: ConnectorOperationOptions = {}): Promise<DocxInsertImageResponse> {
        const requestPath = `/convert/edit/docx/insert-image`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DocxInsertImageResponse>("Cloudmersiveconvert.editDocumentDocxInsertImage", "EditDocument_DocxInsertImage", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxInsertParagraph(input: InsertDocxInsertParagraphRequest, options: ConnectorOperationOptions = {}): Promise<InsertDocxInsertParagraphResponse> {
        const requestPath = `/convert/edit/docx/insert-paragraph`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<InsertDocxInsertParagraphResponse>("Cloudmersiveconvert.editDocumentDocxInsertParagraph", "EditDocument_DocxInsertParagraph", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxInsertTable(input: InsertDocxTablesRequest, options: ConnectorOperationOptions = {}): Promise<InsertDocxTablesResponse> {
        const requestPath = `/convert/edit/docx/insert-table`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<InsertDocxTablesResponse>("Cloudmersiveconvert.editDocumentDocxInsertTable", "EditDocument_DocxInsertTable", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentDocxInsertTableRow(input: InsertDocxTableRowRequest, options: ConnectorOperationOptions = {}): Promise<InsertDocxTableRowResponse> {
        const requestPath = `/convert/edit/docx/insert-table-row`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<InsertDocxTableRowResponse>("Cloudmersiveconvert.editDocumentDocxInsertTableRow", "EditDocument_DocxInsertTableRow", "POST", requestUrl, input, options);
     ...
     */
    public async removeEditDocumentDocxHeadersAndFooters(input: RemoveDocxHeadersAndFootersRequest, options: ConnectorOperationOptions = {}): Promise<RemoveDocxHeadersAndFootersResponse> {
        const requestPath = `/convert/edit/docx/remove-headers-and-footers`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<RemoveDocxHeadersAndFootersResponse>("Cloudmersiveconvert.removeEditDocumentDocxHeadersAndFooters", "EditDocument_DocxRemoveHeadersAndFooters", "POST", requestUrl, input, options);
     ...
     */
    public async removeEditDocumentDocxObject(input: DocxRemoveObjectRequest, options: ConnectorOperationOptions = {}): Promise<DocxRemoveObjectResponse> {
        const requestPath = `/convert/edit/docx/remove-object`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DocxRemoveObjectResponse>("Cloudmersiveconvert.removeEditDocumentDocxObject", "EditDocument_DocxRemoveObject", "POST", requestUrl, input, options);
     ...
     * @remarks Set the footer in a Word Document (DOCX).  Call Finish Editing on the output URL to complete the operation.
     */
    public async setEditDocumentDocxFooter(input: DocxSetFooterRequest, options: ConnectorOperationOptions = {}): Promise<DocxSetFooterResponse> {
        const requestPath = `/convert/edit/docx/set-footer`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DocxSetFooterResponse>("Cloudmersiveconvert.setEditDocumentDocxFooter", "EditDocument_DocxSetFooter", "POST", requestUrl, input, options);
     ...
     */
    public async addEditDocumentDocxSetFooterPageNumber(input: DocxSetFooterAddPageNumberRequest, options: ConnectorOperationOptions = {}): Promise<DocxSetFooterResponse> {
        const requestPath = `/convert/edit/docx/set-footer/add-page-number`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DocxSetFooterResponse>("Cloudmersiveconvert.addEditDocumentDocxSetFooterPageNumber", "EditDocument_DocxSetFooterAddPageNumber", "POST", requestUrl, input, options);
     ...
     */
    public async setEditDocumentDocxHeader(input: DocxSetHeaderRequest, options: ConnectorOperationOptions = {}): Promise<DocxSetHeaderResponse> {
        const requestPath = `/convert/edit/docx/set-header`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<DocxSetHeaderResponse>("Cloudmersiveconvert.setEditDocumentDocxHeader", "EditDocument_DocxSetHeader", "POST", requestUrl, input, options);
     ...
     */
    public async updateEditDocumentDocxTableCell(input: UpdateDocxTableCellRequest, options: ConnectorOperationOptions = {}): Promise<UpdateDocxTableCellResponse> {
        const requestPath = `/convert/edit/docx/update-table-cell`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UpdateDocxTableCellResponse>("Cloudmersiveconvert.updateEditDocumentDocxTableCell", "EditDocument_DocxUpdateTableCell", "POST", requestUrl, input, options);
     ...
     */
    public async updateEditDocumentDocxTableRow(input: UpdateDocxTableRowRequest, options: ConnectorOperationOptions = {}): Promise<UpdateDocxTableRowResponse> {
        const requestPath = `/convert/edit/docx/update-table-row`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<UpdateDocxTableRowResponse>("Cloudmersiveconvert.updateEditDocumentDocxTableRow", "EditDocument_DocxUpdateTableRow", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentXlsxClearCellByIndex(input: ClearXlsxCellRequest, options: ConnectorOperationOptions = {}): Promise<ClearXlsxCellResponse> {
        const requestPath = `/convert/edit/xlsx/clear-cell/by-index`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<ClearXlsxCellResponse>("Cloudmersiveconvert.editDocumentXlsxClearCellByIndex", "EditDocument_XlsxClearCellByIndex", "POST", requestUrl, input, options);
     ...
     */
    public async createEditDocumentXlsxBlankSpreadsheet(input: CreateBlankSpreadsheetRequest, options: ConnectorOperationOptions = {}): Promise<CreateBlankSpreadsheetResponse> {
        const requestPath = `/convert/edit/xlsx/create/blank`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateBlankSpreadsheetResponse>("Cloudmersiveconvert.createEditDocumentXlsxBlankSpreadsheet", "EditDocument_XlsxCreateBlankSpreadsheet", "POST", requestUrl, input, options);
     ...
     */
    public async createEditDocumentXlsxSpreadsheetFromData(input: CreateSpreadsheetFromDataRequest, options: ConnectorOperationOptions = {}): Promise<CreateSpreadsheetFromDataResponse> {
        const requestPath = `/convert/edit/xlsx/create/from/data`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<CreateSpreadsheetFromDataResponse>("Cloudmersiveconvert.createEditDocumentXlsxSpreadsheetFromData", "EditDocument_XlsxCreateSpreadsheetFromData", "POST", requestUrl, input, options);
     ...
     */
    public async deleteEditDocumentXlsxWorksheet(input: RemoveXlsxWorksheetRequest, options: ConnectorOperationOptions = {}): Promise<EditDocumentXlsxDeleteWorksheetResponse> {
        const requestPath = `/convert/edit/xlsx/delete-worksheet`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<EditDocumentXlsxDeleteWorksheetResponse>("Cloudmersiveconvert.deleteEditDocumentXlsxWorksheet", "EditDocument_XlsxDeleteWorksheet", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxCellByIdentifier(input: GetXlsxCellByIdentifierRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxCellByIdentifierResponse> {
        const requestPath = `/convert/edit/xlsx/get-cell/by-identifier`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxCellByIdentifierResponse>("Cloudmersiveconvert.getEditDocumentXlsxCellByIdentifier", "EditDocument_XlsxGetCellByIdentifier", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxCellByIndex(input: GetXlsxCellRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxCellResponse> {
        const requestPath = `/convert/edit/xlsx/get-cell/by-index`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxCellResponse>("Cloudmersiveconvert.getEditDocumentXlsxCellByIndex", "EditDocument_XlsxGetCellByIndex", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxColumns(input: GetXlsxColumnsRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxColumnsResponse> {
        const requestPath = `/convert/edit/xlsx/get-columns`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxColumnsResponse>("Cloudmersiveconvert.getEditDocumentXlsxColumns", "EditDocument_XlsxGetColumns", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxImages(input: GetXlsxImagesRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxImagesResponse> {
        const requestPath = `/convert/edit/xlsx/get-images`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxImagesResponse>("Cloudmersiveconvert.getEditDocumentXlsxImages", "EditDocument_XlsxGetImages", "POST", requestUrl, input, options);
     ...
     * @remarks Returns the rows and cells defined in the Excel Spreadsheet worksheet
     */
    public async getEditDocumentXlsxRowsAndCells(input: GetXlsxRowsAndCellsRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxRowsAndCellsResponse> {
        const requestPath = `/convert/edit/xlsx/get-rows-and-cells`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxRowsAndCellsResponse>("Cloudmersiveconvert.getEditDocumentXlsxRowsAndCells", "EditDocument_XlsxGetRowsAndCells", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxStyles(input: GetXlsxStylesRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxStylesResponse> {
        const requestPath = `/convert/edit/xlsx/get-styles`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxStylesResponse>("Cloudmersiveconvert.getEditDocumentXlsxStyles", "EditDocument_XlsxGetStyles", "POST", requestUrl, input, options);
     ...
     */
    public async getEditDocumentXlsxWorksheets(input: GetXlsxWorksheetsRequest, options: ConnectorOperationOptions = {}): Promise<GetXlsxWorksheetsResponse> {
        const requestPath = `/convert/edit/xlsx/get-worksheets`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<GetXlsxWorksheetsResponse>("Cloudmersiveconvert.getEditDocumentXlsxWorksheets", "EditDocument_XlsxGetWorksheets", "POST", requestUrl, input, options);
     ...
     */
    public async editDocumentXlsxInsertWorksheet(input: InsertXlsxWorksheetRequest, options: ConnectorOperationOptions = {}): Promise<InsertXlsxWorksheetResponse> {
        const requestPath = `/convert/edit/xlsx/insert-worksheet`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<InsertXlsxWorksheetResponse>("Cloudmersiveconvert.editDocumentXlsxInsertWorksheet", "EditDocument_XlsxInsertWorksheet", "POST", requestUrl, input, options);
     ...
     */
    public async setEditDocumentXlsxCellByIdentifier(input: SetXlsxCellByIdentifierRequest, options: ConnectorOperationOptions = {}): Promise<SetXlsxCellByIdentifierResponse> {
        const requestPath = `/convert/edit/xlsx/set-cell/by-identifier`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<SetXlsxCellByIdentifierResponse>("Cloudmersiveconvert.setEditDocumentXlsxCellByIdentifier", "EditDocument_XlsxSetCellByIdentifier", "POST", requestUrl, input, options);
     ...
     */
    public async setEditDocumentXlsxCellByIndex(input: SetXlsxCellRequest, options: ConnectorOperationOptions = {}): Promise<SetXlsxCellResponse> {
        const requestPath = `/convert/edit/xlsx/set-cell/by-index`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<SetXlsxCellResponse>("Cloudmersiveconvert.setEditDocumentXlsxCellByIndex", "EditDocument_XlsxSetCellByIndex", "POST", requestUrl, input, options);
     ...
     */
    public async convertDataJsonToXml(input: ConvertDataJsonToXmlInput, options: ConnectorOperationOptions = {}): Promise<string> {
        const requestPath = `/convert/json/to/xml`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<string>("Cloudmersiveconvert.convertDataJsonToXml", "ConvertData_JsonToXml", "POST", requestUrl, input, options);
     ...
     */
    public async convertTemplateApplyHtmlTemplate(input: HtmlTemplateApplicationRequest, options: ConnectorOperationOptions = {}): Promise<HtmlTemplateApplicationResponse> {
        const requestPath = `/convert/template/html/apply`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<HtmlTemplateApplicationResponse>("Cloudmersiveconvert.convertTemplateApplyHtmlTemplate", "ConvertTemplate_ApplyHtmlTemplate", "POST", requestUrl, input, options);
     ...
     */
    public async convertWebHtmlToPng(input: HtmlToPngRequest, options: ConnectorOperationOptions = {}): Promise<ConvertWebHtmlToPngResponse> {
        const requestPath = `/convert/web/html/to/png`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<ConvertWebHtmlToPngResponse>("Cloudmersiveconvert.convertWebHtmlToPng", "ConvertWeb_HtmlToPng", "POST", requestUrl, input, options);
     ...
     */
    public async convertWebHtmlToTxt(input: HtmlToTextRequest, options: ConnectorOperationOptions = {}): Promise<HtmlToTextResponse> {
        const requestPath = `/convert/web/html/to/txt`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<HtmlToTextResponse>("Cloudmersiveconvert.convertWebHtmlToTxt", "ConvertWeb_HtmlToTxt", "POST", requestUrl, input, options);
     ...
     */
    public async convertWebUrlToTxt(input: UrlToTextRequest, options: ConnectorOperationOptions = {}): Promise<UrlToTextResponse> {
