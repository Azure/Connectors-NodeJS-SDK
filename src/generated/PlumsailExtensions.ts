...
export class PlumsailClient extends ConnectorClientBase {
     ...
     */
    public async flowV1DocumentsJobsSplitPdfV2Async(input: FlowV1DocumentsJobsSplitPdfV2Input, type?: string, abortSignal?: AbortSignal): Promise<DocumentsWithFilenamesResponse> {
     ...
     */
    public async flowV1DocumentsJobsAddWatermarkToPdfAsync(input: FlowV1DocumentsJobsAddWatermarkToPdfInput, type?: string, abortSignal?: AbortSignal): Promise<DocumentProcessingResponse> {
        const queryParams: string[] = [];
        if (type !== undefined) {
            queryParams.push(`type=${encodeURIComponent(String(type))}`);
        }
     ...
     */
    public async flowV1ProcessesFlowJobsExecuteProcessAsync(input: FlowV1ProcessesFlowJobsExecuteProcessInput, processId?: string, abortSignal?: AbortSignal): Promise<Blob> {
        const queryParams: string[] = [];
     ...
     */
    public async flowV1ProcessesFlowJobsExecuteProcessWithGeneratedDataAsync(input: ProcessJsonData, processId?: string, abortSignal?: AbortSignal): Promise<Blob> {
        const queryParams: string[] = [];
        if (processId !== undefined) {
            queryParams.push(`processId=${encodeURIComponent(String(processId))}`);
        }
