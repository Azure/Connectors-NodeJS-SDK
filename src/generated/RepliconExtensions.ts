...
export class RepliconClient extends ConnectorClientBase {
     ...
     */
    public async getMyTenantEndpointDetails(options: ConnectorOperationOptions = {}): Promise<TenantEndpointDetails> {
        const requestPath = `/DiscoveryService1.svc/GetMyTenantEndpointDetails`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<TenantEndpointDetails>("Replicon.getMyTenantEndpointDetails", "GetMyTenantEndpointDetails", "POST", requestUrl, undefined, options);
