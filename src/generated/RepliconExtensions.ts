...
export class RepliconClient extends ConnectorClientBase {
     ...
     */
    public async bulkGetProjectDetails3Async(input: BulkGetProjectDetails3Input, hostUrl?: string, abortSignal?: AbortSignal): Promise<ProjectDetailsResponse> {
     ...
     */
    public async createProjectOrApplyModificationsAsync(input: CreateProjectOrApplyModificationsInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<CreateProjectOrApplyModificationsResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async userListServiceGetDataAsync(input: UserListServiceGetDataInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<UserListServiceGetDataResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async getDescendantTaskDetailsAsync(input: GetDescendantTaskDetailsInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<GetDescendantTaskDetailsResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async createTaskHierarchyOrApplyModificationsAsync(input: CreateTaskHierarchyOrApplyModificationsInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<CreateTaskHierarchyOrApplyModificationsResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async moveTaskAsync(input: MoveTaskInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async taskListServiceGetDataAsync(input: TaskListServiceGetDataInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<TaskListServiceGetDataResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async getTimesheetSummaryAsync(input: GetTimesheetSummaryInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<GetTimesheetSummaryResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async bulkGetTimeEnteredSummaryAsync(input: BulkGetTimeEnteredSummaryInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<BulkGetTimeEnteredSummaryResponse> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async putProjectTeamMemberAssignmentsAsync(input: PutProjectTeamMemberAssignmentsInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async putResourceAssignmentsAsync(input: PutResourceAssignmentsInput, hostUrl?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (hostUrl !== undefined) {
            queryParams.push(`hostUrl=${encodeURIComponent(String(hostUrl))}`);
        }
     ...
     */
    public async getMyTenantEndpointDetailsAsync(abortSignal?: AbortSignal): Promise<TenantEndpointDetails> {
