...
export class OrderfulClient extends ConnectorClientBase {
     ...
     */
    public async listTransactionsAsync(abortSignal?: AbortSignal): Promise<void> {
     ...
     */
    public async createTransactionAsync(input: CreateTransactionInput, abortSignal?: AbortSignal): Promise<void> {
        const requestPath = `/v2/transactions`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async getTransactionByIdAsync(transactionId: string, abortSignal?: AbortSignal): Promise<void> {
