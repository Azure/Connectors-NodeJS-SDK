...
export class AzureiotcentralClient extends ConnectorClientBase {
     ...
     */
    public async deviceGroupsListAsync(application?: string, abortSignal?: AbortSignal): Promise<DeviceGroupCollection> {
     ...
     */
    public async deviceGroupsGetAsync(deviceGroupId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceGroup> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceGroupsSetAsync(input: DeviceGroup, deviceGroupId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceGroup> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceGroupsRemoveAsync(deviceGroupId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceGroupsGetDevicesAsync(deviceGroupId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceGroupDeviceCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetCloudPropertiesAsync(deviceId: string, application?: string, instanceOf?: string, abortSignal?: AbortSignal): Promise<DeviceCloudProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesUpdateCloudPropertiesAsync(input: DeviceCloudProperties, deviceId: string, application?: string, instanceOf?: string, abortSignal?: AbortSignal): Promise<DeviceCloudProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesExecuteComponentCommandAsync(input: DeviceCommand, deviceId: string, componentName: string, commandName: string, application?: string, instanceOf?: string, abortSignal?: AbortSignal): Promise<DeviceCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceRelationshipsListAsync(deviceId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceRelationshipCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceRelationshipsGetAsync(deviceId: string, relationshipId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceRelationshipStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceRelationshipsSetAsync(input: DeviceRelationship, relationshipId: string, deviceId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceRelationshipStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceRelationshipsUpdateAsync(input: DeviceRelationship, deviceId: string, relationshipId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceRelationshipStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceRelationshipsRemoveAsync(deviceId: string, relationshipId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsListAsync(application?: string, abortSignal?: AbortSignal): Promise<JobCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsGetAsync(jobId: string, application?: string, abortSignal?: AbortSignal): Promise<JobStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsSetAsync(input: Job, jobId: string, application?: string, jobType?: string, abortSignal?: AbortSignal): Promise<Job> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsGetDevicesAsync(jobId: string, application?: string, abortSignal?: AbortSignal): Promise<JobDeviceStatusCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsStopAsync(jobId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsResumeAsync(jobId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async jobsRerunAsync(jobId: string, rerunId: string, application?: string, abortSignal?: AbortSignal): Promise<JobStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async organizationsListAsync(application?: string, abortSignal?: AbortSignal): Promise<OrganizationCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async organizationsGetAsync(organizationId: string, application?: string, abortSignal?: AbortSignal): Promise<Organization> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async organizationsSetAsync(input: Organization, organizationId: string, application?: string, abortSignal?: AbortSignal): Promise<Organization> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async organizationsRemoveAsync(organizationId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsListAsync(application?: string, abortSignal?: AbortSignal): Promise<ScheduledJobCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsGetAsync(scheduledJobId: string, application?: string, abortSignal?: AbortSignal): Promise<ScheduledJob> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsSetAsync(input: ScheduledJob, scheduledJobId: string, application?: string, jobType?: string, scheduledJobEndType?: string, abortSignal?: AbortSignal): Promise<ScheduledJob> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsUpdateAsync(input: ScheduledJobPatch, scheduledJobId: string, application?: string, scheduledJobEndType?: string, abortSignal?: AbortSignal): Promise<ScheduledJobStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsRemoveAsync(scheduledJobId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async scheduledJobsListJobsAsync(scheduledJobId: string, application?: string, abortSignal?: AbortSignal): Promise<ScheduledJobJobCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetAsync(deviceId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceV1> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetCommandResponseAsync(deviceId: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceCommandV1> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetComponentCommandResponseAsync(deviceId: string, componentName: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceComponentCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetComponentTelemetryValueAsync(deviceId: string, componentName: string, telemetryName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceComponentTelemetry> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetModuleCommandResponseAsync(deviceId: string, module: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetModuleComponentCommandResponseAsync(deviceId: string, module: string, componentName: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleComponentCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetModuleComponentTelemetryValueAsync(deviceId: string, module: string, componentName: string, telemetryName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleComponentTelemetry> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetModulePropertiesAsync(deviceId: string, module: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<ModuleProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetModuleTelemetryValueAsync(deviceId: string, module: string, telemetryName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleTelemetry> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetPropertiesAsync(deviceId: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesGetTelemetryValueAsync(deviceId: string, telemetryName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceTelemetry> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesListAsync(application?: string, abortSignal?: AbortSignal): Promise<DeviceCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesRemoveAsync(deviceId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesRunCommandAsync(input: DeviceCommandV1, deviceId: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceCommandV1> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesRunComponentCommandAsync(input: DeviceComponentCommand, deviceId: string, componentName: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceComponentCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesRunModuleCommandAsync(input: DeviceModuleCommand, deviceId: string, module: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesRunModuleComponentCommandAsync(input: DeviceModuleComponentCommand, deviceId: string, module: string, componentName: string, commandName: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceModuleComponentCommand> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesSetAsync(input: DeviceV2, deviceId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceV2> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesUpdateModulePropertiesAsync(input: ModuleProperties, deviceId: string, module: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<ModuleProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async devicesUpdatePropertiesAsync(input: DeviceProperties, deviceId: string, application?: string, template?: string, abortSignal?: AbortSignal): Promise<DeviceProperties> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceTemplatesGetAsync(templateId: string, application?: string, abortSignal?: AbortSignal): Promise<DeviceTemplate> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceTemplatesListAsync(application?: string, abortSignal?: AbortSignal): Promise<DeviceTemplateCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async deviceTemplatesRemoveAsync(templateId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async rolesGetAsync(roleId: string, application?: string, abortSignal?: AbortSignal): Promise<Role> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async rolesListAsync(application?: string, abortSignal?: AbortSignal): Promise<RoleCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async usersCreateAsync(input: User, userId: string, application?: string, userType?: string, abortSignal?: AbortSignal): Promise<User> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async usersGetAsync(userId: string, application?: string, abortSignal?: AbortSignal): Promise<UserStatic> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async usersListAsync(application?: string, abortSignal?: AbortSignal): Promise<UserCollection> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async usersRemoveAsync(userId: string, application?: string, abortSignal?: AbortSignal): Promise<void> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
     ...
     */
    public async usersUpdateAsync(input: UserPatch, userId: string, application?: string, userType?: string, abortSignal?: AbortSignal): Promise<UserPatch> {
        const queryParams: string[] = [];
        if (application !== undefined) {
            queryParams.push(`application=${encodeURIComponent(String(application))}`);
        }
