...
export class SigninghubClient extends ConnectorClientBase {
     ...
     */
    public async contactsGetAsync(recordPerPage: string, pageNo: string, sortBy?: string, asc?: string, abortSignal?: AbortSignal): Promise<Array<ContactResponse>> {
     ...
     */
    public async packageDownloadPackageBytesAsync(packageIdBulkAction: string, documentIds?: string, abortSignal?: AbortSignal): Promise<PackageDownloadPackageBytesResponse> {
        const queryParams: string[] = [];
     ...
     */
    public async packageGetAllPackagesAsync(documentStatus: string, pageNo: string, recordPerPage: string, packageName?: string, packageId?: string, recipientFrom?: string, recipientTo?: string, documentId?: string, expiry?: string, modifiedFrom?: string, modifiedTo?: string, sizeFrom?: string, sizeTo?: string, certifiedDocuments?: string, formFields?: string, attachments?: string, documentType?: string, sortBy?: string, asc?: string, documentStatuses?: string, ownedBy?: string, smartForm?: string, abortSignal?: AbortSignal): Promise<Array<GetPackagesResponse>> {
        const queryParams: string[] = [];
     ...
     */
    public async settingsGetTemplatesAsync(recordPerPage: string, pageNo: string, sortBy?: string, asc?: string, abortSignal?: AbortSignal): Promise<Array<TemplateResponse>> {
        const queryParams: string[] = [];
        if (sortBy !== undefined) {
            queryParams.push(`sort-by=${encodeURIComponent(String(sortBy))}`);
        }
     ...
     */
    public async templateGetEnterpriseTemplatesAsync(recordPerPage: string, pageNo: string, sortBy?: string, asc?: string, id?: string, abortSignal?: AbortSignal): Promise<Array<EnterpriseTemplateResponse>> {
        const queryParams: string[] = [];
        if (sortBy !== undefined) {
            queryParams.push(`sort-by=${encodeURIComponent(String(sortBy))}`);
        }
