...
export class ArmClient extends ConnectorClientBase {
    ...
    public listSubscriptionsLocations(subscriptionId: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Location> {
        ...
        return this.createPageable<LocationListResult, Location>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<LocationListResult>("Arm.listSubscriptionsLocations", "Subscriptions_ListLocations", "GET", requestUrl, undefined, options);
    ...
    public listSubscriptions(xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Subscription> {
        ...
        return this.createPageable<SubscriptionListResult, Subscription>(
            ...
            async (requestUrl, isFirstPage) => {
                ...
                const httpResponse = await this.sendWithTracingAsync<SubscriptionListResult>("Arm.listSubscriptions", "Subscriptions_List", requestMethod, requestUrl, undefined, options);
    ...
    public listDeployments(subscriptionId: string, resourceGroupName: string, filter?: string, top?: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<DeploymentExtended> {
        ...
        return this.createPageable<DeploymentListResult, DeploymentExtended>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<DeploymentListResult>("Arm.listDeployments", "Deployments_List", requestMethod, requestUrl, undefined, options);
    ...
    public listDeploymentOperations(subscriptionId: string, resourceGroupName: string, deploymentName: string, top?: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<DeploymentOperation> {
        ...
        return this.createPageable<DeploymentOperationsListResult, DeploymentOperation>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<DeploymentOperationsListResult>("Arm.listDeploymentOperations", "DeploymentOperations_List", requestMethod, requestUrl, undefined, options);
    ...
    public listProviders(subscriptionId: string, top?: string, expand?: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Provider> {
        ...
        return this.createPageable<ProviderListResult, Provider>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<ProviderListResult>("Arm.listProviders", "Providers_List", requestMethod, requestUrl, undefined, options);
    ...
    public listResourceGroupsResources(subscriptionId: string, resourceGroupName: string, xMsApiVersion?: string, filter?: string, expand?: string, top?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<GenericResource> {
        ...
        return this.createPageable<ResourceListResult, GenericResource>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<ResourceListResult>("Arm.listResourceGroupsResources", "ResourceGroups_ListResources", requestMethod, requestUrl, undefined, options);
    ...
    public listResourceGroups(subscriptionId: string, xMsApiVersion?: string, filter?: string, top?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<ResourceGroup> {
        ...
        return this.createPageable<ResourceGroupListResult, ResourceGroup>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<ResourceGroupListResult>("Arm.listResourceGroups", "ResourceGroups_List", requestMethod, requestUrl, undefined, options);
    ...
    public listResources(subscriptionId: string, filter?: string, expand?: string, top?: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<GenericResource> {
        ...
        return this.createPageable<ResourceListResult, GenericResource>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<ResourceListResult>("Arm.listResources", "Resources_List", requestMethod, requestUrl, undefined, options);
    ...
    public listTags(subscriptionId: string, xMsApiVersion?: string, options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<TagDetails> {
        ...
        return this.createPageable<TagsListResult, TagDetails>(
            ...
            async (requestUrl, isFirstPage) => {
                const requestMethod = isFirstPage ? "GET" : "GET";
                const httpResponse = await this.sendWithTracingAsync<TagsListResult>("Arm.listTags", "Tags_List", requestMethod, requestUrl, undefined, options);
