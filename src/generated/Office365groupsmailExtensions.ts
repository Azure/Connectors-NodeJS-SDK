...
export class Office365groupsmailClient extends ConnectorClientBase {
     ...
     */
    public async listConversationsAsync(groupId: string, abortSignal?: AbortSignalLike): Promise<ListConversationsResponse> {
     ...
     */
    public async listConversationThreadsAsync(groupId: string, conversationId: string, abortSignal?: AbortSignalLike): Promise<ListConversationThreadsResponse> {
     ...
     */
    public async listGroupThreadsAsync(groupId: string, abortSignal?: AbortSignalLike): Promise<ListGroupThreadsResponse> {
     ...
     */
    public async listThreadPostsAsync(groupId: string, threadId: string, abortSignal?: AbortSignalLike): Promise<ListThreadPostsResponse> {
     ...
     */
    public async getAttachmentsAsync(groupId: string, threadId: string, postId: string, abortSignal?: AbortSignalLike): Promise<GetAttachmentsResponse> {
