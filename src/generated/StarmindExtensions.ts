...
export class StarmindClient extends ConnectorClientBase {
     ...
     */
    public async findExpertsAsync(input: FindExpertsInput, abortSignal?: AbortSignal): Promise<FindExpertsResponse> {
     ...
     */
    public async findQuestionsAsync(query?: string, limit?: string, filter?: string, sort?: string, abortSignal?: AbortSignal): Promise<FindQuestionsResponse> {
     ...
     */
    public async getUserByIdAsync(id: string, abortSignal?: AbortSignal): Promise<GraphQLUserResponse> {
     ...
     */
    public async postQuestionDraftAsync(input: PostQuestionDraftInput, abortSignal?: AbortSignal): Promise<Question> {
     ...
     */
    public async publishQuestionDraftAsync(questionId: string, abortSignal?: AbortSignal): Promise<PublishQuestionDraftResponse> {
