...
export class StarmindClient extends ConnectorClientBase {
     ...
     */
    public async findExperts(input: FindExpertsInput, options: ConnectorOperationOptions = {}): Promise<FindExpertsResponse> {
        const requestPath = `/api/v3/experts`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<FindExpertsResponse>("Starmind.findExperts", "FindExperts_V3", "POST", requestUrl, input, options);
    ...
    public async findQuestions(options: FindQuestionsOptions = {}): Promise<FindQuestionsResponse> {
        ...
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<FindQuestionsResponse>("Starmind.findQuestions", "FindQuestions_V3", "GET", requestUrl, undefined, options);
     ...
     */
    public async postQuestionDraft(input: PostQuestionDraftInput, options: ConnectorOperationOptions = {}): Promise<Question> {
        const requestPath = `/api/v3/questions`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Question>("Starmind.postQuestionDraft", "PostQuestionDraft_V3", "POST", requestUrl, input, options);
