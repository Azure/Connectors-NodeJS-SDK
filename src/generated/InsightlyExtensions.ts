...
export class InsightlyClient extends ConnectorClientBase {
     ...
     * @remarks List tasks
     */
    public listTasks(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<TaskObject> {
        const requestPath = `/Tasks`;
        return this.createPageable<ListTasksResponse, TaskObject>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<ListTasksResponse>("Insightly.listTasks", "ListTasks", "GET", requestUrl, undefined, options);
     ...
     * @remarks Add task
     */
    public async addTask(input: TaskRequest, options: ConnectorOperationOptions = {}): Promise<TaskObject> {
        const requestPath = `/Tasks`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<TaskObject>("Insightly.addTask", "AddTask", "POST", requestUrl, input, options);
     ...
     */
    public listProjects(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Project> {
        const requestPath = `/Projects`;
        return this.createPageable<ListProjectsResponse, Project>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<ListProjectsResponse>("Insightly.listProjects", "ListProjects", "GET", requestUrl, undefined, options);
     ...
     * @remarks Add project
     */
    public async addProject(input: ProjectRequest, options: ConnectorOperationOptions = {}): Promise<Project> {
        const requestPath = `/Projects`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Project>("Insightly.addProject", "AddProject", "POST", requestUrl, input, options);
     ...
     * @remarks List leads
     */
    public listLeads(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Lead> {
        const requestPath = `/Leads`;
        return this.createPageable<ListLeadsResponse, Lead>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<ListLeadsResponse>("Insightly.listLeads", "ListLeads", "GET", requestUrl, undefined, options);
     ...
     * @remarks Add lead
     */
    public async addLead(input: LeadRequest, options: ConnectorOperationOptions = {}): Promise<Lead> {
        const requestPath = `/Leads`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Lead>("Insightly.addLead", "AddLead", "POST", requestUrl, input, options);
     ...
     */
    public listContacts(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<Contact> {
        const requestPath = `/Contacts`;
        return this.createPageable<ListContactsResponse, Contact>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<ListContactsResponse>("Insightly.listContacts", "ListContacts", "GET", requestUrl, undefined, options);
     ...
     * @remarks Add contact
     */
    public async addContact(input: ContactRequest, options: ConnectorOperationOptions = {}): Promise<Contact> {
        const requestPath = `/Contacts`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Contact>("Insightly.addContact", "AddContact", "POST", requestUrl, input, options);
     ...
     * @remarks List users
     */
    public listUsers(options: ConnectorOperationOptions = {}): ConnectorPagedAsyncIterableIterator<User> {
        const requestPath = `/Users`;
        return this.createPageable<ListUsersResponse, User>(
            requestPath,
            async (requestUrl) => {
                const httpResponse = await this.sendWithTracingAsync<ListUsersResponse>("Insightly.listUsers", "ListUsers", "GET", requestUrl, undefined, options);
     ...
     */
    public async addOrganization(input: OrganizationRequest, options: ConnectorOperationOptions = {}): Promise<Organization> {
        const requestPath = `/Organisations`;
        const requestUrl = this.resolveUrl(requestPath);
        const httpResponse = await this.sendWithTracingAsync<Organization>("Insightly.addOrganization", "AddOrganization", "POST", requestUrl, input, options);
