...
export class ElfsquaddataClient extends ConnectorClientBase {
     ...
     */
    public async getEntitiesAsync(entityName: string, top?: string, skip?: string, orderby?: string, filter?: string, select?: string, expand?: string, count?: string, abortSignal?: AbortSignal): Promise<GetEntitiesResponse> {
     ...
     */
    public async postEntityByIdAsync(input: PostEntityByIdInput, entityName: string, abortSignal?: AbortSignal): Promise<PostEntityByIdResponse> {
     ...
     */
    public async getEntityByIdAsync(entityName: string, id: string, abortSignal?: AbortSignal): Promise<GetEntityByIdResponse> {
     ...
     */
    public async deleteEntityByIdAsync(entityName: string, id: string, abortSignal?: AbortSignal): Promise<void> {
        const requestPath = `/data/1/${entityName}(${id})`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async putEntityByIdAsync(input: PutEntityByIdInput, entityName: string, id: string, abortSignal?: AbortSignal): Promise<void> {
        const requestPath = `/data/1/${entityName}(${id})`;
        const requestUrl = this.resolveUrl(requestPath);
     ...
     */
    public async invokeFunctionAsync(input: InvokeFunctionInput, functionPath: string, abortSignal?: AbortSignal): Promise<InvokeFunctionResponse> {
