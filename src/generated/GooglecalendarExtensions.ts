...
export class GooglecalendarClient extends ConnectorClientBase {
     ...
     */
    public async listCalendarsAsync(minAccessRole?: string, abortSignal?: AbortSignal): Promise<CalendarList> {
     ...
     */
    public async listEventsAsync(calendarId: string, timeMin?: string, timeMax?: string, q?: string, abortSignal?: AbortSignal): Promise<CalendarEventList> {
        const queryParams: string[] = [];
