...
describe("FtpClient — constructor", () => {
    it("should construct with valid options", () => {
        const client = new FtpClient(TestConnectionUrl, createMockCredential());
    ...
    it("should throw on null connection URL", () => {
        expect(() => new FtpClient(null as unknown as string, createMockCredential()))
            .toThrow("Parameter 'connectionRuntimeUrl' cannot be null or undefined.");
    });

    it("should throw on undefined connection URL", () => {
        expect(() => new FtpClient(undefined as unknown as string, createMockCredential()))
            .toThrow("Parameter 'connectionRuntimeUrl' cannot be null or undefined.");
    });
});

describe("FtpClient — getFileMetadata", () => {
    afterEach(() => {
        jest.restoreAllMocks();
    });
