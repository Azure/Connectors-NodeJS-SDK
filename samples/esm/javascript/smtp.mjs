...
/**
 * SMTP Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates how to use the SMTP connector with ESM imports in plain JavaScript.
 *
 * Prerequisites:
...
import { SmtpClient } from "@azure/connectors/generated/SmtpExtensions";
...
async function main() {
    console.log("SMTP Connector SDK — ESM JavaScript Sample");
