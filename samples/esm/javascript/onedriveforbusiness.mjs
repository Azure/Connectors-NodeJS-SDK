...
/**
 * OneDrive for Business Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates how to use the OneDrive for Business connector with ESM imports in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("OneDrive for Business Connector SDK — ESM JavaScript Sample");
