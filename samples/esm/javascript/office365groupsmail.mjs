...
/**
 * Office 365 Groups Mail Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates using the Office 365 Groups Mail connector with ESM imports in plain JavaScript.
 *
 * Usage:
