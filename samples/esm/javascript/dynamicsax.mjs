...
/**
 * Fin & Ops Apps (Dynamics 365) Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates using the Fin & Ops Apps (Dynamics 365) connector with ESM imports in plain JavaScript.
 *
 * Usage:
