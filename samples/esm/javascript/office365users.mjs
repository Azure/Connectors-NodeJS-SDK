...
/**
 * Office 365 Users Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates how to use the Office 365 Users connector with ESM imports in plain JavaScript.
 *
 * Prerequisites:
...
import { Office365usersClient } from "@azure/connectors/generated/Office365usersExtensions";
...
async function main() {
    console.log("Office 365 Users Connector SDK — ESM JavaScript Sample");
