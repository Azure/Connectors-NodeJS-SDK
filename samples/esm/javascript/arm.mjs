...
/**
 * Azure Resource Manager Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates how to use the ARM connector with ESM imports in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("Azure Resource Manager Connector SDK — ESM JavaScript Sample");
