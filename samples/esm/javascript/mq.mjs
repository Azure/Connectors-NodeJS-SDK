...
/**
 * IBM MQ Connector SDK Sample — ESM JavaScript
 *
 * Demonstrates how to use the IBM MQ connector with ESM imports in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("IBM MQ Connector SDK — ESM JavaScript Sample");
