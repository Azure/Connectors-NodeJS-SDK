...
/**
 * Fin & Ops Apps (Dynamics 365) Connector SDK Sample — ESM TypeScript
 *
 * Demonstrates using the Fin & Ops Apps (Dynamics 365) connector with ESM imports in TypeScript.
 *
 * Usage:
