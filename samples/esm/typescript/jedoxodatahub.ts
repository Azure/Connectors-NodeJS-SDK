...
/** Jedox OData Hub Connector SDK Sample - ESM TypeScript. */
...
async function main(): Promise<void> {
    try {
        const databases = await new JedoxodatahubClient(CONNECTION_URL, new ManagedIdentityTokenProvider()).databases({ top: 10 });
