...
/**
 * Office365 Connector SDK Sample — ESM TypeScript
 *
 * Demonstrates how to use the Office365 connector with ESM imports in TypeScript.
 *
 * Prerequisites:
...
import { Office365Client, ClientSendHtmlMessage } from "@azure/azure-connectors/generated/Office365Extensions";
...
async function main(): Promise<void> {
    console.log("Office365 Connector SDK — ESM TypeScript Sample");
