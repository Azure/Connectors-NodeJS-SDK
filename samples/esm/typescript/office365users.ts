...
/**
 * Office 365 Users Connector SDK Sample — ESM TypeScript
 *
 * Demonstrates how to use the Office 365 Users connector with ESM imports in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("Office 365 Users Connector SDK — ESM TypeScript Sample");
    ...
    console.log("\n--- Trending Documents ---");
    try {
        const trendingResponse: MyTrendingDocumentsResponse = await client.myTrendingDocuments();
    ...
    console.log("\n--- My Direct Reports ---");
    try {
        const reports: DirectReportsResponse = await client.directReports("me");
