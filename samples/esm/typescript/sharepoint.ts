...
/**
 * SharePoint Online Connector SDK Sample — ESM TypeScript
 *
 * Demonstrates how to use the SharePoint Online connector with ESM imports in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("SharePoint Online Connector SDK — ESM TypeScript Sample");
