...
/**
 * OneDrive for Business Connector SDK Sample — ESM TypeScript
 *
 * Demonstrates how to use the OneDrive for Business connector with ESM imports in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("OneDrive for Business Connector SDK — ESM TypeScript Sample");
    ...
    if (fileId) {
        ...
        try {
            const metadata: BlobMetadata = await client.getFileMetadata(fileId);
