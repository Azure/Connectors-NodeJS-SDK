...
/**
 * Office365 Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the Office365 connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("Office365 Connector SDK — CJS JavaScript Sample");
    ...
    try {
        const email = {
            ...
            Subject: "Test from CJS JavaScript Sample",
            Body: "<p>Hello from the <strong>CJS JavaScript</strong> sample!</p>",
        };
