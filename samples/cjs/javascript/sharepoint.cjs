...
/**
 * SharePoint Online Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the SharePoint Online connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("SharePoint Online Connector SDK — CJS JavaScript Sample");
