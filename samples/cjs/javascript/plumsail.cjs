...
/**
 * Plumsail Documents Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Plumsail Documents connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { PlumsailClient } = require("@azure/connectors/generated/PlumsailExtensions");
