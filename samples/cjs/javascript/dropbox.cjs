...
/**
 * Dropbox Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Dropbox connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { DropboxClient } = require("@azure/connectors/generated/DropboxExtensions");
