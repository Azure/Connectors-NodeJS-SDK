...
/**
 * Azure Resource Manager Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the ARM connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("Azure Resource Manager Connector SDK — CJS JavaScript Sample");
