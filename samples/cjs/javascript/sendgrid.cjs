...
/**
 * SendGrid Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the SendGrid connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { SendgridClient } = require("@azure/connectors/generated/SendgridExtensions");
