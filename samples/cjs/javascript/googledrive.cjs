...
/**
 * Google Drive Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Google Drive connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { GoogledriveClient } = require("@azure/connectors/generated/GoogledriveExtensions");
