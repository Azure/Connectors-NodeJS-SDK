...
/**
 * Box Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Box connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { BoxClient } = require("@azure/connectors/generated/BoxExtensions");
