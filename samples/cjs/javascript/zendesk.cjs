...
/**
 * Zendesk Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Zendesk connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { ZendeskClient } = require("@azure/connectors/generated/ZendeskExtensions");
