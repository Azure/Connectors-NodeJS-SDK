...
/**
 * SMTP Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the SMTP connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("SMTP Connector SDK — CJS JavaScript Sample");
