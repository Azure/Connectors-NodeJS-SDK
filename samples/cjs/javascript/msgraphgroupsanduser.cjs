...
/**
 * Microsoft Graph Groups & Users Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the MS Graph Groups & Users connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("MS Graph Groups & Users Connector SDK — CJS JavaScript Sample");
