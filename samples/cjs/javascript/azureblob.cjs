...
/**
 * Azure Blob Storage Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the Azure Blob Storage connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("Azure Blob Storage Connector SDK — CJS JavaScript Sample");
