...
/**
 * OneDrive for Business Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the OneDrive for Business connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
const { OnedriveforbusinessClient } = require("@azure/connectors/generated/OnedriveforbusinessExtensions");
...
async function main() {
    console.log("OneDrive for Business Connector SDK — CJS JavaScript Sample");
