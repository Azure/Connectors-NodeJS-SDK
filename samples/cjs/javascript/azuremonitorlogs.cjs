...
/**
 * Azure Monitor Logs Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates how to use the Azure Monitor Logs connector with CommonJS require() in plain JavaScript.
 *
 * Prerequisites:
...
async function main() {
    console.log("Azure Monitor Logs Connector SDK — CJS JavaScript Sample");
