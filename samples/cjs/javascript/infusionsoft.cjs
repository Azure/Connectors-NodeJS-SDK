...
/**
 * Infusionsoft Connector SDK Sample — CJS JavaScript
 *
 * Demonstrates using the Infusionsoft connector with CommonJS require() in plain JavaScript.
 *
 * Usage:
...
const { InfusionsoftClient } = require("@azure/connectors/generated/InfusionsoftExtensions");
