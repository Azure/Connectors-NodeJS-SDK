...
/**
 * SMTP Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates how to use the SMTP connector with CommonJS module output in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("SMTP Connector SDK — CJS TypeScript Sample");
