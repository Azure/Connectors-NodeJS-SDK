...
/**
 * Cloudmersive Document Conversion Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates using the Cloudmersive Document Conversion connector with CommonJS module output in TypeScript.
 *
 * Usage:
