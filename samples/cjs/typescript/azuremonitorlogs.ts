...
/**
 * Azure Monitor Logs Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates how to use the Azure Monitor Logs connector with CommonJS module output in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("Azure Monitor Logs Connector SDK — CJS TypeScript Sample");
