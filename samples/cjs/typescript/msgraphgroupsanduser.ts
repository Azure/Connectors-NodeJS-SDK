...
/**
 * Microsoft Graph Groups & Users Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates how to use the MS Graph Groups & Users connector with CommonJS module output in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("MS Graph Groups & Users Connector SDK — CJS TypeScript Sample");
