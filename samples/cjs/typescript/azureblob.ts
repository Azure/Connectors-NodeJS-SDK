...
/**
 * Azure Blob Storage Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates how to use the Azure Blob Storage connector with CommonJS module output in TypeScript.
 *
 * Prerequisites:
...
import { AzureblobClient, BlobMetadata, ListOfBlobsWithSensitivityLabels, SharedAccessSignature, SharedAccessSignatureBlobPolicy } from "@azure/connectors/generated/AzureblobExtensions";
...
async function main(): Promise<void> {
    console.log("Azure Blob Storage Connector SDK — CJS TypeScript Sample");
