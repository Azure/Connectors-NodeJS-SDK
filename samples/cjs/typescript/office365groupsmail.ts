...
/**
 * Office 365 Groups Mail Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates using the Office 365 Groups Mail connector with CommonJS module output in TypeScript.
 *
 * Usage:
