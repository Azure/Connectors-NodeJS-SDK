...
/**
 * Kusto (Azure Data Explorer) Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates how to use the Kusto connector with CommonJS in TypeScript.
 *
 * Prerequisites:
...
async function main(): Promise<void> {
    console.log("Kusto (Azure Data Explorer) Connector SDK — CJS TypeScript Sample");
