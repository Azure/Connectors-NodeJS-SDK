...
/**
 * Azure IoT Central Connector SDK Sample — CJS TypeScript
 *
 * Demonstrates using the Azure IoT Central connector with CommonJS module output in TypeScript.
 *
 * Usage:
